...
public class DipTest {
    ...
    public void testHashCode() {
        ...
        if (!dip3.equals(dip1)) { 
            assertNotEquals(dip1.hashCode(), dip3.hashCode(), "Different Dip objects should have different hashCodes.");
        }

        assertEquals(dip1.hashCode(), dip2.hashCode(), "Equal Dip objects should have the same hashCode.");
    }
}
